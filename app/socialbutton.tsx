...
const HeroSection: React.FC<{ isVisible: boolean }> = ({ isVisible }) => {
  const socialLinks = [
    { href: "https://github.com/Abdulmalik899", icon: Github, label: "GitHub", color: "bg-purple-600 hover:bg-purple-700 hover:shadow-purple-500/50" },
    { href: "https://linkedin.com/in/abdulkareem-abdulmalik", icon: Linkedin, label: "LinkedIn", color: "bg-blue-600 hover:bg-blue-700 hover:shadow-blue-500/50" },
    { href: "mailto:shinobicode77@gmail.com", icon: Mail, label: "Email", color: "bg-pink-600 hover:bg-pink-700 hover:shadow-pink-500/50" }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className={`text-center transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed">
            ...
            Year 3 Systems Engineering student at University of Lagos, passionate about 
